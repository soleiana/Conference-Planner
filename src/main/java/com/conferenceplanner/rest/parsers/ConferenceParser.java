...
public class ConferenceParser {
    ...
    public static ConferenceInterval parse(String startDateTimeString, String endDateTimeString) {
        try {
            LocalDateTime startDateTime = LocalDateTime.parse(startDateTimeString.trim(), DATE_TIME_FORMATTER);
            LocalDateTime endDateTime = LocalDateTime.parse(endDateTimeString.trim(), DATE_TIME_FORMATTER);
